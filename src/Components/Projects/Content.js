        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="text-start px-4 py-2 fs-4">
                    ...
                    <div class="tech-im">
                        <img src={Python} class="rounded my-1 mx-2" alt="Python" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={JSON} class="rounded my-1 mx-2" alt="JSON" style={{width:"50px", height: "50px"}} data-aos="fade" />
                    </div>
                </div>
                <div class="text-start px-4 py-2 fs-4">
                    <div><b>Libraries Used: </b></div>
                    <div class="tech-im pr-0">
                        <img src={Tensorflow} class="rounded my-1 mx-2" alt="Tensorflow" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={NLTK} class="rounded my-1 mx-2" alt="NLTK" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={NumPy} class="rounded my-1 mx-2" alt="NumPy" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={Tkinter} class="rounded my-1 mx-2" alt="Tkinter" style={{width:"50px", height: "50px"}} data-aos="fade" />
                    </div>
                </div>
                <div class="text-start px-4 py-2 fs-4">
                    <div><b>Tools Used: </b></div>
                    <div class="tech-im">
                        <img src={Anaconda} class="rounded my-1 mx-2" alt="Anaconda" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={Spyder} class="rounded my-1 mx-2" alt="Spyder" style={{width:"80px", height: "50px"}} data-aos="fade" />
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid bg-dark text-white">
            ...
            <div class="container">
                ...
                <div class="text-start px-4 py-2 fs-4">
                    ...
                    <div class="tech-im">
                        <img src={Python} class="rounded my-1 mx-2" alt="Python" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={Cpp} class="rounded my-1 mx-2" alt="C++" style={{width:"50px", height: "50px"}} data-aos="fade" />
                    </div>
                </div>
                <div class="text-start px-4 py-2 fs-4">
                    <div><b>Libraries Used: </b></div>
                    <div class="tech-im pr-0">
                        <img src={IBMIOT} class="rounded my-1 mx-2" alt="IBM IOT" style={{width:"70px", height: "50px"}} data-aos="fade" />
                        <img src={OpenWeather} class="rounded my-1 mx-2" alt="Open Weather" style={{width:"80px", height: "50px"}} data-aos="fade" />
                        <img src={IBMWatson} class="rounded my-1 mx-2" alt="IBM Watson" style={{width:"50px", height: "50px"}} data-aos="fade" />
                    </div>
                </div>
                <div class="text-start px-4 pt-2 pb-4 fs-4">
                    <div><b>Tools Used: </b></div>
                    <div class="tech-im">
                        <img src={IBMCloud} class="rounded my-1 mx-2" alt="IBM Cloud" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={NodeRed} class="rounded my-1 mx-2" alt="Node Red" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={Wokwi} class="rounded my-1 mx-2 bg-light" alt="Wokwi" style={{width:"80px", height: "50px"}} data-aos="fade" />
                        <img src={MITApp} class="rounded my-1 mx-2" alt="MIT App Inventor" style={{width:"70px", height: "50px"}} data-aos="fade" />
                        <img src={PythonIdle} class="rounded my-1 mx-2" alt="Python Idle" style={{width:"50px", height: "50px"}} data-aos="fade" />
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="text-start px-4 py-2 fs-4">
                    <div><b>Technologies Used: </b></div>
                    <div class="tech-im">
                        <img src={HTML} class="rounded my-1 mx-2" alt="HTML" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={CSS} class="rounded my-1 mx-2" alt="CSS" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={JavaScript} class="rounded my-1 mx-2" alt="JavaScript" style={{width:"60px", height: "60px"}} data-aos="fade" />
                        <img src={PHP} class="rounded my-1 mx-2" alt="PHP" style={{width:"60px", height: "50px"}} data-aos="fade" />
                        <img src={MySQL} class="rounded my-1 mx-2" alt="MySQL" style={{width:"70px", height: "50px"}} data-aos="fade" />
                    </div>
                </div>
                <div class="text-start px-4 py-2 fs-4">
                    <div><b>Tools Used: </b></div>
                    <div class="tech-im">
                        <img src={VSCode} class="rounded my-1 mx-2" alt="VSCode" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={Xampp} class="rounded my-1 mx-2" alt="Xampp" style={{width:"50px", height: "50px"}} data-aos="fade" />
                        <img src={PostgreSQL} class="rounded my-1 mx-2" alt="PostgreSQL" style={{width:"50px", height: "50px"}} data-aos="fade" />
                    </div>
                </div>
            </div>
        </div>
